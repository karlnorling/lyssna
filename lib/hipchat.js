...
module.exports = function (config, context) {
  ...
  var getMessageTemplate = function (snsMessage) {
    ...
    if (!applicationConfig) {
      context.fail(format.util('HipchatLib (getMessageTemplate): No application config found for applicationName: "%s" in config: "%s"', snsMessage.applicationName, config))
      return
    }
